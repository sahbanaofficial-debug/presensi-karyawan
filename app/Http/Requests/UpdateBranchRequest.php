...
{
    /**
     * Hanya HRD yang dapat mengubah data cabang.
     */
    ...
    /**
     * Aturan validasi perubahan cabang.
     *
    ...
    /**
     * Mengabaikan kode milik cabang yang sedang diperbarui.
     */
    private function uniqueCodeRule(): Unique
    {
        ...
        $rule = Rule::unique('branches', 'code');

        if ($branchId !== null) {
            $rule->ignore($branchId);
        }
    ...
    /**
     * Mengubah nilai angka kosong menjadi null.
     */
