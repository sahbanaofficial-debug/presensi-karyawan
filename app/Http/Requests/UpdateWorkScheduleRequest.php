...
{
    /**
     * Hanya HRD yang dapat mengubah pola jadwal kerja.
     */
    ...
    /**
     * Aturan validasi perubahan pola jadwal kerja.
     *
    ...
    /**
     * Nama jadwal milik data yang sedang diedit
    ...
    private function uniqueNameRule(): Unique
    {
        ...
        $workSchedule = $this->routeWorkSchedule();
    ...
    /**
     * Mengambil model dari parameter route {work_schedule}.
     */
    private function routeWorkSchedule(): ?WorkSchedule
    {
        $workSchedule = $this->route(
            'work_schedule'
        );
        ...
        if (
            is_numeric($workSchedule)
            && (int) $workSchedule > 0
        ) {
            return WorkSchedule::query()->find(
                (int) $workSchedule
            );
        }
    ...
    /**
     * Menormalisasi waktu HH:MM:SS menjadi HH:MM.
     */
